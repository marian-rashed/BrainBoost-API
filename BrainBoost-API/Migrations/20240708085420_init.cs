        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalApplicationUserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NumOfCrsEnrolled = table.Column<int>(type: "int", nullable: true),
                    NumOfCertificates = table.Column<int>(type: "int", nullable: true),
                    NumOfCrsSaved = table.Column<int>(type: "int", nullable: true),
                    Fname = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Lname = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PictureUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    QuizState = table.Column<bool>(type: "bit", nullable: false),
                    CertificateState = table.Column<bool>(type: "bit", nullable: false),
                    hasFinishedallVideos = table.Column<bool>(type: "bit", nullable: false),
                    StudentId = table.Column<int>(type: "int", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CourseId = table.Column<int>(type: "int", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentSavedCourses", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizQuesitons", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizQuesitons_QuestionId",
                table: "QuizQuesitons",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_QuizQuesitons_QuizId",
                table: "QuizQuesitons",
                column: "QuizId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentEnrolledCourses_CourseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentSavedCourses_CourseId",
                table: "StudentSavedCourses",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentSavedCourses_StudentId",
                table: "StudentSavedCourses",
                column: "StudentId");
